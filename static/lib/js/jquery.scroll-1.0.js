...
用法注释：HTML中格式<div id="scroll"><div id="inner"></div></div>
inner为滚动对象层 方法传入 "#inner"
scroll为滚动对象外部层，用于定义宽高，无需传入方法
*/
jQuery.extend({
    Scroll: function(settings) {
        ...
        var config = $.extend({
            ...
            inner: "",              // 滚动对象 传入示范 #abc,.abc
            left: "",               // 左点击对象 传入示范 #abc,.abc
            right: ""               // 右点击对象 传入示范 #abc,.abc
        }, settings);
