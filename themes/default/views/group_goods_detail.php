...
<a href="/">首页</a> » 
<a href="<?php echo url::encode('group_buy'); ?>">团购</a> » <a href="<?php echo $page['info']['group_url']; ?>"><?php echo $page['info']['info_title']; ?></a>
</div>
    ...
    <div class="wrap_content l">
        ...
        <div class="clearfix">
            ...
            <div class="goods_photo_right_box l">
            	<h1 class="goods_h1"><?php echo $page['info']['group_goods_name']; ?></h1>
                ...
                <div>原价：<span class="goods_now_price_num"><?php echo $page['info']['now_price']; ?></span></div>
                <div class="goods_now_price">团购价：<span class="goods_now_price_num"><?php echo $page['info']['group_price']; ?></span></div>
                <div class="lxftime endtime" endtime="<?php echo date('Y-m-d H:i:s',$page['info']['end_time']); ?>"></div>
                <div class="goods_shop_bar_box">   
                	<div>购买数量： <input name="number" type="text" id="number008" value="1" size="4"  style="border:1px solid #ccc; "/>
                    <div><a onclick="return go_get_order(this,'#number008')"  href="/get_order.php?type=group_buy&goods_id=<?php echo $page['info']['info_id']; ?>&num=1" class="btnB" >抢购</a>
                    </div>
            	</div>
            </div>
        </div>
