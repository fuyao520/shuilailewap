...
<div class="wrap width mt10 clearfix">
    <div class="wrap_content r">        
        <div class="goods_list_box clearfix">
            <?php $a=get_group_goods_list(array('pagesize'=>10,'p'=>$page['get']['p'])); ?>
			<?php foreach($a['list'] as $r){?>
            <div class="goods_list_block">
                <p class="pttxt01"><a href="<?php echo $r['group_url']; ?>"><img src="<?php echo $r['info_img']; ?>" alt="<?php echo $r['title']; ?>" class="goodimg" /></a></P>
                <p class="pttxt02"><a href="<?php echo $r['group_url']; ?>" title="<?php echo $r['title']; ?>"><?php echo $r['title']; ?></a></p>
                <p class="pttxt03">原价：￥<?php echo $r['now_price']; ?>元</p>
                <p class="pttxt03">团购价：￥<?php echo $r['group_price']; ?></p>
                <p class="lxftime" endtime="<?php echo date('Y-m-d H:i:s',$r['end_time']); ?>"></p>
                <p class="pttxt05">
                    <a href="<?php echo $r['group_url']; ?>" >马上去抢</a>
                </p>
            </div>
            <?php }?>
        </div>
